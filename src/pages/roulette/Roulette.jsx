  ...
  return (
    <div className="wrapper pt-5 lg:pt-16 pb-8 ">
      <div className="contain justify-center items-center">
        <div className="grid w-full gap-8 2xl:grid-cols-[350px__1fr] 2xl:gap-5 bg-white rounded-xl overflow-hidden">
          <div className="flex justify-start items-center flex-col bg-gray-400 w-full px-5 py-8">
            ...
            <button className="text-white bg-black w-full py-3 border-2 border-solid border-black hover:bg-transparent hover:text-black text-lg mt-5 rounded-xl font-semibold transition-all duration-300">
              Spin Now
            </button>
